...
var Vm = p0.exports, Gp = {}, h0 = { exports: {} }, Xa = {}, jm = { exports: {} }, f0 = {};
/**
 * @license React
...
var rR;
function lR() {
  return rR || (rR = 1, process.env.NODE_ENV === "production" ? jm.exports = eD() : jm.exports = tD()), jm.exports;
}
/**
 * @license React
...
function rD() {
  return iR || (iR = 1, process.env.NODE_ENV !== "production" && function() {
    typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(new Error());
    var ie = Pm, Z = lR(), F = ie.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, Kt = !1;
    function on(e) {
      Kt = e;
    }
    function lt(e) {
...
Check the render method of \`` + e + "`." : "";
    ...
    var Ia = !1, qd = "dangerouslySetInnerHTML", dh = "suppressContentEditableWarning", _o = "suppressHydrationWarning", M0 = "autoFocus", Ms = "children", Ns = "style", ph = "__html", Dy, vh, Xd, N0, hh, z0, U0;
    Dy = {
...
`).replace(LR, "");
    ...
    function NR(e, t, a, i, u) {
      for (var s in i)
        if (i.hasOwnProperty(s)) {
          ...
          else s === dh || s === _o || s === M0 || (it.hasOwnProperty(s) ? f != null && (typeof f != "function" && hh(s, f), s === "onScroll" && Sn("scroll", t)) : f != null && va(t, s, f, u));
        }
    }
    function zR(e, t, a, i) {
    ...
    function jR(e, t, a, i, u) {
      ...
      for (v in f)
        if (!(p.hasOwnProperty(v) || !f.hasOwnProperty(v) || f[v] == null))
          ...
          } else v === qd || v === Ms || v === dh || v === _o || v === M0 || (it.hasOwnProperty(v) ? s || (s = []) : (s = s || []).push(v, null));
      for (v in p) {
    ...
    var Sh = "suppressHydrationWarning", Eh = "$", Ch = "/$", Jd = "$?", ep = "$!", qR = "style", Ny = null, zy = null;
    function XR(e) {
    ...
    function Xi(e, t, a, i, u) {
      {
        ...
        for (var f in e)
          if (s(e, f)) {
            ...
            p && !(p instanceof Error) && (xh(u), S("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", i || "React class", a, f, typeof p), xh(null)), p instanceof Error && !(p.message in I0) && (I0[p.message] = !0, xh(u), S("Failed %s type: %s", a, p.message), xh(null));
          }
      }
    }
    var $y = [], bh;
    ...
    function zh(e) {
      ...
      if (!Ki)
        return iE(e), Ki = !0, !1;
      if (e.tag !== ne && (e.tag !== ue || jT(e.type) && !Uy(e.type, e.memoizedProps))) {
        var t = bi;
        if (t)
          if (Zy(e))
            lE(e), Jy();
...
Please update the following components: %s`, b);
      ...
      var Uh = /* @__PURE__ */ new Map(), oE = /* @__PURE__ */ new Set();
...
See https://reactjs.org/link/refs-must-have-owner for more information.`);
    ...
    var yE = 0, gE = 1, Bh = 2, pg = 3, $h = !1, vg, Yh;
    vg = !1, Yh = null;
    function hg(e) {
      var t = {
    ...
    function No(e, t, a) {
      ...
      if (i === null)
        return null;
      var u = i.shared;
      if (Yh === u && !vg && (S("An update (setState, replaceState, or forceUpdate) was scheduled from inside an update function. Update functions should be pure, with zero side-effects. Consider using componentDidUpdate or a callback."), vg = !0), kb()) {
        var s = u.pending;
    ...
    function TE(e) {
      qh(Gh.current);
      var t = qh(zo.current), a = KR(t, e.type);
    ...
    wg = /* @__PURE__ */ new Set();
    var Bs = B, It = null, or = null, sr = null, Kh = !1, mp = !1, yp = 0, jw = 0, Hw = 25, P = null, _i = null, Ao = -1, xg = !1;
    function Vt() {
      {
        var e = P;
...
Incoming: %s`, P, "[" + t.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function Lg(e, t, a) {
      ...
      return u.queue = y, nm(LE.bind(null, i, y, e), [e]), i.flags |= sn, gp(lr | zr, OE.bind(null, i, y, s, t), void 0, null), s;
    }
    function Zh(e, t, a) {
      var i = It, u = Di(), s = t();
      if (!Df) {
    ...
    function im(e, t, a) {
      ...
      return tm(Ke, ur, zE.bind(null, t, e), i);
    }
    function Pw(e, t) {
    }
    var lm = Pw;
    ...
    function Pg() {
      var e = Jh(!1), t = e[0], a = e[1], i = Bw.bind(null, a), u = jl();
    ...
    }, IE = null, QE = null, WE = null, GE = null, Hl = null, el = null, fm = null;
    {
      var $g = function() {
      ...
      IE = {
        ...
        useDeferredValue: function(e) {
          return P = "useDeferredValue", Qe(), te(), AE(e);
        },
        useTransition: function() {
          return P = "useTransition", Qe(), te(), HE();
        },
        useMutableSource: function(e, t, a) {
          return P = "useMutableSource", Qe(), te(), void 0;
        },
    ...
    var Fo = Z.unstable_now, qE = 0, dm = -1, Cp = -1, pm = -1, Yg = !1, vm = !1;
    function XE() {
      return Yg;
    }
    function Qw() {
    ...
    var qg = {}, Xg, Kg, Zg, Jg, eS, eC, mm, tS, nS, rS, Rp;
    {
    ...
    var iS = {
      ...
      enqueueReplaceState: function(e, t, a) {
        var i = Ma(e), u = wa(), s = Po(i), f = wu(u, s);
        f.tag = gE, f.payload = t, a != null && (mm(a, "replaceState"), f.callback = a);
        var p = No(i, f, s);
        p !== null && (pr(p, i, s, u), Ih(p, i, s)), ds(i, s);
      },
...
https://reactjs.org/link/unsafe-component-lifecycles`, le, Le, M !== null ? `
  ...
  ` + j : ""));
    ...
    function lS(e, t, a, i) {
      ...
      if (typeof v == "function" && (aS(e, t, v, a), u.state = e.memoizedState), typeof t.getDerivedStateFromProps != "function" && typeof u.getSnapshotBeforeUpdate != "function" && (typeof u.UNSAFE_componentWillMount == "function" || typeof u.componentWillMount == "function") && (Xw(e, u), Qh(e, a, u, i), u.state = e.memoizedState), typeof u.componentDidMount == "function") {
        var y = Ke;
    ...
    function Zw(e, t, a, i, u) {
      ...
      var Le = Wh() || nC(t, a, p, i, j, le, b) || // TODO: In some cases, we'll end up checking if context has changed twice,
...
` + ("" + y);
    ...
    function hC(e, t, a, i, u) {
      ...
      var U = t.stateNode, j;
      U === null ? (Sm(e, t), aC(t, a, i), lS(t, a, i, u), j = !0) : e === null ? j = Kw(t, a, i, u) : j = Zw(e, t, a, i, u);
    ...
    function px(e, t, a, i, u) {
      Sm(e, t), t.tag = de;
      var s;
      return Al(a) ? (s = !0, kh(t)) : s = !1, wf(t, u), aC(t, a, i), lS(t, a, i, u), mS(null, t, a, !0, s, u);
    }
    function vx(e, t, a, i) {
      Sm(e, t);
      ...
      if (
        ...
        var w = !1;
        return Al(a) ? (w = !0, kh(t)) : w = !1, t.memoizedState = p.state !== null && p.state !== void 0 ? p.state : null, hg(t), rC(t, p), lS(t, a, u, i), mS(null, t, a, !0, w, i);
      } else {
...
Check the render method of \`` + i + "`.");
        ...
        case bt: {
          ...
          if (Ot === null)
            if (Qt)
              ...
              Ge.tail !== null && yn() > KC() && (t.flags |= $e, Qt = !0, _p(Ge, !1), t.lanes = Nv);
            }
          else {
            if (!Qt) {
              var Vr = Xh(Ot);
              ...
              // exceed it.
              yn() * 2 - Ge.renderingStartTime > KC() && a !== Cr && (t.flags |= $e, Qt = !0, _p(Ge, !1), t.lanes = Nv);
            }
            if (Ge.isBackwards)
    ...
    var MC = null;
    MC = /* @__PURE__ */ new Set();
    var Em = !1, Ar = !1, Ax = typeof WeakSet == "function" ? WeakSet : Set, Se = null, Nf = null, zf = null;
    function Fx(e) {
      tu(null, function() {
        throw e;
      }), cd();
...
Learn more about data fetching with Hooks: https://reactjs.org/link/hooks-data-fetching` : y = " You returned: " + p, S("%s must not return anything besides a function, which is used for clean-up.%s", v, y);
    ...
    var Tb = Math.ceil, kS = F.ReactCurrentDispatcher, OS = F.ReactCurrentOwner, jr = F.ReactCurrentBatchConfig, ll = F.ReactCurrentActQueue, cr = (
      ...
      /*                */
      4
    ), bu = 0, kp = 1, Is = 2, Rm = 3, Op = 4, GC = 5, LS = 6, Ct = cr, Ta = null, Mn = null, fr = B, $l = B, MS = ko(B), dr = bu, Lp = null, Tm = B, Mp = B, wm = B, Np = null, Ga = null, NS = 0, qC = 500, XC = 1 / 0, wb = 500, _u = null;
    function zp() {
      XC = yn() + wb;
    }
    function KC() {
    ...
    var xm = !1, zS = null, Af = null, Qs = !1, Vo = null, Up = B, US = [], AS = null, xb = 50, Ap = 0, FS = null, jS = !1, bm = !1, bb = 50, Ff = 0, _m = null, Fp = en, Dm = B, ZC = !1;
    function km() {
      return Ta;
    }
    function wa() {
    ...
    function pr(e, t, a, i) {
      Kb(), ZC && S("useInsertionEffect must not schedule updates."), jS && (bm = !0), du(e, a, i), (Ct & Hr) !== B && e === Ta ? e_(t) : (Sa && $c(e, t, a), t_(t), e === Ta && ((Ct & Hr) === cr && (Mp = qe(Mp, a)), dr === Op && Bo(e, fr)), qa(e, i), a === De && Ct === cr && (t.mode & we) === Ce && // Treat `act` as if it's inside `batchedUpdates`, even in legacy mode.
    ...
    function JC(e, t) {
      ...
      if (u === B)
        return null;
      var s = !gs(e, u) && !Vv(e, u) && !t, f = s ? Hb(e, u) : Lm(e, u);
      if (f !== bu) {
        if (f === Is) {
          var p = kl(e);
          p !== B && (u = p, f = HS(e, p));
      ...
      switch (t) {
        ...
        case Op: {
          if (Bo(e, a), Hv(a))
            break;
          if (!h1()) {
            var f = zv(e, a), p = f, v = yn() - p, y = Xb(v) - v;
            if (y > 10) {
    ...
    function Ws(e, t) {
      ...
      return Mn = s, fr = $l = t, dr = bu, Lp = null, Tm = B, Mp = B, wm = B, Np = null, Ga = null, Dw(), Zi.discardPendingWarnings(), s;
    }
    function r1(e, t) {
      do {
        var a = Mn;
        try {
          if (Vh(), _E(), Cn(), OS.current = null, a === null || a.return === null) {
            dr = kp, Lp = t, Mn = null;
            return;
          }
    ...
    function Hb(e, t) {
      ...
      while (!0);
      return Vh(), i1(i), Ct = a, Mn !== null ? (Cc(), bu) : (Rc(), Ta = null, fr = B, dr);
    }
    function Vb() {
      for (; Mn !== null && !hc(); )
        l1(Mn);
    ...
    function l1(e) {
      ...
      jt(e);
      var a;
      (e.mode & Ye) !== Ce ? (Ig(e), a = $S(t, e, $l), hm(e, !0)) : a = $S(t, e, $l), Cn(), e.memoizedProps = e.pendingProps, a === null ? u1(e) : Mn = a, OS.current = null;
    }
    function u1(e) {
      var t = e;
      do {
        ...
        if ((t.flags & ma) === Oe) {
          jt(t);
          var u = void 0;
          if ((t.mode & Ye) === Ce ? u = OC(a, t, $l) : (Ig(t), u = OC(a, t, $l), hm(t, !1)), Cn(), u !== null) {
            Mn = u;
            return;
          }
        } else {
    ...
    function Pb(e, t, a, i) {
      ...
      if (p || v) {
        ...
        Tn(On);
        var b = Ct;
        Ct |= ki, OS.current = null, Vx(e, u), ZE(), eb(e, u, s), JR(e.containerInfo), e.current = u, Sd(s), tb(u, e, s), to(), bv(), Ct = b, Tn(g), jr.transition = y;
      } else
        e.current = u, ZE();
      var w = Qs;
      if (Qs ? (Qs = !1, Vo = e, Up = s) : (Ff = 0, _m = null), f = e.pendingLanes, f === B && (Af = null), w || f1(e.current, !1), Zu(u.stateNode, i), Sa && e.memoizedUpdaters.clear(), Eb(), qa(e, yn()), t !== null)
    ...
    function $b() {
      ...
      Ed(), f1(t.current, !0), Ct = i, Lo(), bm ? t === _m ? Ff++ : (Ff = 0, _m = t) : Ff = 0, jS = !1, bm = !1, ja(t);
      {
...
%s`, a);
    ...
    function Wb(e, t, a) {
      ...
      i !== null && i.delete(t);
      var u = wa();
      Pc(e, a), n_(e), Ta === e && fu(fr, a) && (dr === Op || dr === Rm && Fv(fr) && yn() - NS < qC ? Ws(e, B) : wm = qe(wm, a)), qa(e, u);
    }
    function c1(e, t) {
      t === Fn && (t = _b(e));
      var a = wa(), i = Qa(e, t);
    ...
    function Kb() {
      ...
      Ff > bb && (Ff = 0, _m = null, S("Maximum update depth exceeded. This can happen when a component calls setState inside useEffect, but useEffect either doesn't have a dependency array, or one of the dependencies changes on every render."));
    }
    function Zb() {
      Zi.flushLegacyContextWarning(), Zi.flushPendingUnsafeLifecycleWarnings();
    }
    function f1(e, t) {
      jt(e), Mm(e, Zr, yb), t && Mm(e, nu, gb), Mm(e, Zr, hb), t && Mm(e, nu, mb), Cn();
    }
    function Mm(e, t, a) {
      ...
      $S = function(e, t, a) {
        ...
        try {
          ...
          if (fw() || s !== null && typeof s == "object" && typeof s.then == "function")
            throw s;
          if (Vh(), _E(), LC(e, t), E1(t, i), t.mode & Ye && Ig(t), tu(null, xC, null, e, t, a), ny()) {
            var u = cd();
...
Check the render method of %s.`, Ie(mn) || "Unknown"));
  ...
  root.render(<App />);`), t.unstable_strictMode === !0 && (a = !0), t.identifierPrefix !== void 0 && (u = t.identifierPrefix), t.onRecoverableError !== void 0 && (s = t.onRecoverableError), t.transitionCallbacks !== void 0 && t.transitionCallbacks);
    ...
    Um.prototype.unstable_scheduleHydration = M_;
    function N_(e, t, a) {
      if (!Am(e))
      ...
      var y = w1(t, null, e, Oh, i, s, f, p, v);
    ...
    vo(R_), oy(T_), Qc(w_), Iv(Va), Qv(Rr), (typeof Map != "function" || // $FlowIssue Flow incorrectly thinks Map has no prototype
    Map.prototype == null || typeof Map.prototype.forEach != "function" || typeof Set != "function" || // $FlowIssue Flow incorrectly thinks Set has no prototype
    Set.prototype == null || typeof Set.prototype.clear != "function" || typeof Set.prototype.forEach != "function") && S("React depends on Map and Set built-in types. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"), Cv($R), sc(VS, Nb, Du);
    function B_(e, t) {
...
const iD = () => /* @__PURE__ */ Vm.jsx(Vm.Fragment, { children: /* @__PURE__ */ Vm.jsx("h1", { children: "A COMPONENT" }) });
class lD extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" });
  }
  connectedCallback() {
    Gp.createRoot(this.shadowRoot).render(/* @__PURE__ */ Vm.jsx(iD, {}));
  }
...
customElements.define("my-simple-component", lD);
