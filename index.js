    ...
    process.env.NODE_ENV !== "production" && function() {
      ...
      function Ee(e, r, a, o, c) {
        ...
        if (f) {
          ...
          } else E != null && (be(E) && (E.key && (!y || y.key !== E.key) && Pe(E.key), E = Rr(
            E,
        ...
        if ($e(e))
          ...
          if (typeof Nr == "function") {
            var lt = e;
            Nr === lt.entries && (Ne || ie("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Ne = !0);
            for (var Lt = Nr.call(lt), dt, Mt = 0; !(dt = Lt.next()).done; )
              A = dt.value, I = B + xe(A, Mt++), N += Ee(A, r, a, I, c);
          } else if (d === "object") {
            var pt = String(e);
...
Check the top-level render call using <` + a + ">.");
      ...
      function ut(e, r, a) {
        ...
        if (o)
          for (var E = 2; E < arguments.length; E++)
            at(arguments[E], e);
        return e === te ? Pt(y) : ot(y), y;
      }
      var it = !1;
      function kt(e) {
        var r = ut.bind(null, e);
        return r.type = e, it || (it = !0, ie("React.createFactory() is deprecated and will be removed in a future major release. Consider using JSX or use React.createElement() directly instead.")), Object.defineProperty(r, "type", {
          enumerable: !1,
          get: function() {
      ...
      v.Children = $t, v.Component = b, v.Fragment = te, v.Profiler = Z, v.PureComponent = w, v.StrictMode = ne, v.Suspense = V, v.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = U, v.act = ft, v.cloneElement = It, v.createContext = sr, v.createElement = Dt, v.createFactory = Ft, v.createRef = gr, v.forwardRef = jr, v.isValidElement = be, v.lazy = kr, v.memo = u, v.startTransition = At, v.unstable_act = ft, v.useCallback = F, v.useContext = p, v.useDebugValue = he, v.useDeferredValue = Ke, v.useEffect = h, v.useId = Ar, v.useImperativeHandle = Re, v.useInsertionEffect = Y, v.useLayoutEffect = D, v.useMemo = J, v.useReducer = S, v.useRef = _, v.useState = C, v.useSyncExternalStore = xr, v.useTransition = q, v.version = Ce, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(Xe, Xe.exports)), Xe.exports;
}
process.env.NODE_ENV === "production" ? Yr.exports = Nt() : Yr.exports = Vt();
var gt = Yr.exports;
/**
 * @license React
    ...
    function Sr(t, u, s, p, C) {
      {
        ...
        return wr(t, h, Y, C, p, _e.current, _);
      }
    }
...
Ur.exports = Ut();
var Vr = Ur.exports;
const Bt = () => /* @__PURE__ */ Vr.jsx(Vr.Fragment, { children: /* @__PURE__ */ Vr.jsx("h1", { children: "A COMPONENT" }) });
defineWebComponent("my-simple-component", Bt);
