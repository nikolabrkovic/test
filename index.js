...
function cr() {
  if (Oe) return A;
  Oe = 1;
  var N = Ce, P = Symbol.for("react.element"), V = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, F = N.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function w(b, c, T) {
    var p, y = {}, E = null, W = null;
    T !== void 0 && (E = "" + T), c.key !== void 0 && (E = "" + c.key), c.ref !== void 0 && (W = c.ref);
    for (p in c) m.call(c, p) && !I.hasOwnProperty(p) && (y[p] = c[p]);
    if (b && b.defaultProps) for (p in c = b.defaultProps, c) y[p] === void 0 && (y[p] = c[p]);
    return { $$typeof: P, type: b, key: E, ref: W, props: y, _owner: F.current };
  }
  return A.Fragment = V, A.jsx = w, A.jsxs = w, A;
}
var D = {};
/**
 * @license React
...
function dr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    var N = Ce, P = Symbol.for("react.element"), V = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), F = Symbol.for("react.strict_mode"), I = Symbol.for("react.profiler"), w = Symbol.for("react.provider"), b = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), T = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), y = Symbol.for("react.memo"), E = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), Q = Symbol.iterator, we = "@@iterator";
    function je(e) {
    ...
    var ke = !1, Ae = !1, De = !1, Fe = !1, Ie = !1, ee;
    ee = Symbol.for("react.module.reference");
    function We(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === I || Ie || e === F || e === T || e === p || Fe || e === W || ke || Ae || De || typeof e == "object" && e !== null && (e.$$typeof === E || e.$$typeof === y || e.$$typeof === w || e.$$typeof === b || e.$$typeof === c || // This needs to include all possible module reference object
    ...
    function Re(e, r) {
      {
        ...
        Ee[t] = !0;
        var n = "";
        e && e._owner && e._owner !== G.current && (n = " It was passed a child from " + h(e._owner.type) + "."), S(e), l('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), S(null);
      }
    }
    function _e(e, r) {
      {
    ...
    function Te(e, r, t, n, o, u) {
      {
        ...
        if (!i) {
          ...
          d ? a += d : a += be();
          var s;
          e === null ? s = "null" : q(e) ? s = "array" : e !== void 0 && e.$$typeof === P ? (s = "<" + (h(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, l("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var f = er(e, r, t, o, u);
        if (f == null)
          return f;
